    ...
    <nav className="border-gray-200">
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="https://Zanderz17.github.io/UCR/Edits/logo_UCR.svg" className="h-20" alt="UCR Logo" />
        </Link>
        ...
        <div className={`md:flex w-full md:w-auto ${isOpen ? '' : 'hidden'}`} id="navbar-default">
          <ul className="font-extrabold flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 text-4xl font-jomhuria">
            <li>
              <Link to="/" className={`block py-2 px-3 ${location.pathname === '/' ? ' md:dark:text-dark-fulizardo' : 'text-white'} rounded md:bg-transparent md:p-0 dark:text-white`} aria-current="page">Home</Link>
            </li>
            <li>
              <Link to="/series" className={`block py-2 px-3 ${location.pathname.startsWith('/series') ? ' md:dark:text-dark-fulizardo' : 'text-white'} rounded md:bg-transparent md:p-0 dark:text-white`}>Series</Link>
            </li>
            <li>
              <Link to="/noticias" className={`block py-2 px-3  ${location.pathname.startsWith('/noticias') ? ' md:dark:text-dark-fulizardo' : 'text-white'} rounded md:bg-transparent md:p-0 dark:text-white`}>Noticias</Link>
            </li>
          </ul>
        </div>
      </div>
